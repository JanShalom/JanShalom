...
#$spID = (Get-AzVM -ResourceGroupName $RG -Name Jan-VM1).identity.principalid
#New-AzRoleAssignment -ObjectId $spID -RoleDefinitionName "Storage Blob Data Contributor" -Scope "/subscriptions/563641ea-4294-4002-aedc-b0a97aa107fe/resourceGroups/$RG/providers/Microsoft.Storage/storageAccounts/jan2msstorage1"
